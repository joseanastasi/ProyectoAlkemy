                              ...
                              <tr>
                                 <td class="hero-bg">
                                    <table cellspacing="0" cellpadding="0" width="100%">
                                       ...
                                       <tr>
                                          <td style="font-size:40px; font-weight: 400; color: #18171c; text-align:center;">
                                             <img src="https://i.postimg.cc/mR559GHD/logo.png" class="desktop-hide" height="250" style="margin: 0 auto;"/>
                                             <br>
                                             Newsletter!
                                             <br>
                                          </td>
                                       ...
                                       <tr>
                                          <td style="font-size:24px; text-align:center; padding: 0 75px; color:#18171c;">
                                             ${message}
                                          </td>
                                       </tr>
                                       <tr>
                                          <td style="font-size:24px; text-align:center; padding: 0 75px; color:#18171c;">
                                             <a href="${url}" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Novedades &rarr;</a>
                                          </td>
                                       </tr>
                                       <tr>
                                             ...
                                             <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="4baad4">
                                                ...
                                                <td align="center">
                                                   <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="4baad4">
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <a href="http://programapaas.com.ar/" border="0" style="text-decoration: none !important; font-size: 18px; font-family: arial, sans-serif; border-style:none; color:#fff;" target="_blank">Visita nuestro <em>sitio web.</em></a>
                                                         </td>
                                                      </tr>
                                                      </td>
                                                      </tr>
                                    ...
                                    <table cellspacing="0" cellpadding="0" bgcolor="#e8ecf0"  class="force-full-width">
                                        <tr>
                                          <td style="color:#27aa90; font-size: 14px; text-align:center;">
                                             <a href="http://localhost:8080/subscribe" class="untracked">Unsubscribe</a>
                                          </td>
                                       </tr>
                                    </table>
                                 </td>
